...
for _, ft_path in ipairs(vim.api.nvim_get_runtime_file("lua/plugins/dap/config/lang/*.lua", true)) do
  loadfile(ft_path)()
end
...
local hint = [[
 Nvim DAP
 _dc_: Start/Continue  _j_: StepOver _k_: StepOut _l_: StepInto ^
